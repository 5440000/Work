...
# # 5. Написать программу, которая принимает в качестве аргумента даты в строковом представлении
# и возвращает количество рабочих дней между ними (пн, вт, ср, чт, пт - рабочие дни, сб, вс - выходные).
# Пример  '2019_7_2', '2019_7_11' - 8 рабочих дней, включая эти даты.
#input("Введите даты в строковом представлении")
# data_1 = (int(2019_7_2))
# data_2 = (int(2019_7_11))
# data_total = data_2 - data_1
# print(data_total)
#
# import calendar
...
# # 23 - True.
# #
# # 8: Написать функцию, которая принимает в качестве аргумента строку и возвращает True, если эта строка "зеркальная".
# # Пример:
# # abba - True
# # hello, world! = False
# # radar - True
...
# # которая бы считала сумму ряда чисел от 1 до переданного ей в качестве аргумента числа.
# # Пример: ввод: 4, результат: 1 + 2 + 3 + 4 = 10.
# #
# # 11: Написать рекурсивную функцию,
# # которая будет считать произведение переданного ей в качестве аргумента список целых чисел.
# # Пример: ввод: [42, 78, 113], результат: 42 * 72 * 113 = 341712.
#
#                                         6
...
# # 2: Написать функцию, которая возвращает первые три символа из каждого слова,
# если в слове меньше, чем три символа, оставшееся место стоит заполнить пробелами.
# Дополнительно сделать тоже самое при помощи регулярных выражений.
#def
import re
s = 'Happy New Year! If you want to be happy - just do it!'
def fff():
    result = globals()
